...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <asp:Panel ID="pnlregistr" runat="server" Visible="False">
            ...
            <br />
            <br /><asp:Panel ID="pnlAkkoord" runat="server" Visible="False" BackColor="#CCCCFF" Font-Bold="False" Font-Italic="False" Font-Size="Larger">
                <span style="color: rgb(75, 79, 86); font-family: Helvetica, Arial, sans-serif; font-size: 12px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: pre-wrap; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(241, 240, 240); text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;">Beste gebruiker
                <br />
                Welkom op onze biedingssite hier worden allerlei school producten verkocht aan de hoogste bieder. Om dit van een leiendakje te laten lopen en ervoor te zorgen dat er geen misbruik wordt gemaakt van de website zijn er natuurlijk enkele regels waarmee je je akkoord moet verklaren.<br /> Regel 1: Je moet je echte naam gebruiken en je e-mail adres die je van het school hebt gekregen
                <br />
                Regel 2: Er mogen geen valse bedragen geboden worden, als je bied moet je betalen!
                <br />
                Regel 3: Er kan geen bod geplaatst worden die lager is dan het minimumbedrag.
                <br />
                Regel 4: In het geval dat een gebruiker misbruik maakt van de biedingssite zal de beheerder de gebruiker in kwestie blokkeren.
                <br />
                Alvast bedankt om u te registreren op onze biedingssite, veel winkelplezier!<br /> We danken u bij voorbaat om akkoord te gaan en het reglement na te leven.</span><br /> 
                <br />
